...
var app = (function () {
    ...
    const file$3 = "node_modules/@zerodevx/svelte-toast/src/ToastItem.svelte";
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$3, 80, 2, 1871);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    const file$4 = "node_modules/@zerodevx/svelte-toast/src/SvelteToast.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(li, file$4, 39, 2, 830);
    			this.first = li;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(ul, file$4, 37, 0, 788);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class SvelteToast extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { options: 2 });
    ...
    async function fetchRoomUrl(id) {
    ...
    async function getRoomId(url) {
        ...
        let roomId = await fetchRoomId(url);
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	function queryServerForRoom() {
    		return __awaiter(this, void 0, void 0, function* () {
    			$$invalidate(0, waitingMsg = "Réticulation des splines...");

    			try {
    				let id = yield getRoomId($peertubeUrl);
    				navigate("/room/" + id);
    			} catch(err) {
    				$$invalidate(0, waitingMsg = `Erreur ! ${err.toString()}`);
    			}
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("waitingMsg" in $$props) $$invalidate(0, waitingMsg = $$props.waitingMsg);
    	};
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty & /*videoTitle*/ 2) {
    				attr_dev(iframe, "title", /*videoTitle*/ ctx[1]);
    			}

    			if (!current || dirty & /*embedUrl*/ 4 && iframe.src !== (iframe_src_value = /*embedUrl*/ ctx[2])) {
    				attr_dev(iframe, "src", iframe_src_value);
    			}

    			const comments_changes = {};
    			if (dirty & /*roomId*/ 1) comments_changes.roomId = /*roomId*/ ctx[0];
    ...
    function create_fragment$8(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*embedUrl*/ ctx[2] === null) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			t0 = text(/*videoTitle*/ ctx[1]);
    			t1 = text(" (#");
    			t2 = text(/*roomId*/ ctx[0]);
    			t3 = text(")");
    			t4 = space();
    			p = element("p");
    			t5 = text("Partagez cette URL avec vos ami.e.s pour qu'iels puissent vous rejoindre et\n    discuter avec vous ! ");
    			input = element("input");
    			t6 = space();
    			if_block.c();
    			if_block_anchor = empty();
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(input, "click", /*copyUrl*/ ctx[4], false, false, false);
    				mounted = true;
    			}
    		},
    		p: function update(ctx, [dirty]) {
    			if (!current || dirty & /*videoTitle*/ 2) set_data_dev(t0, /*videoTitle*/ ctx[1]);
    			if (!current || dirty & /*roomId*/ 1) set_data_dev(t2, /*roomId*/ ctx[0]);
    			let previous_block_index = current_block_type_index;
    			current_block_type_index = select_block_type(ctx);
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	onMount(function onMount() {
    		return __awaiter(this, void 0, void 0, function* () {
    			...
    			try {
    				...
    				$$invalidate(1, videoTitle = json.name);
    			} catch(err) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Room> was created with unknown prop '${key}'`);
    	});

    	function input_binding($$value) {
    		binding_callbacks[$$value ? "unshift" : "push"](() => {
    			urlField = $$value;
    			$$invalidate(3, urlField);
    		});
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("__awaiter" in $$props) __awaiter = $$props.__awaiter;
    		if ("roomId" in $$props) $$invalidate(0, roomId = $$props.roomId);
    		if ("videoTitle" in $$props) $$invalidate(1, videoTitle = $$props.videoTitle);
    		if ("embedUrl" in $$props) $$invalidate(2, embedUrl = $$props.embedUrl);
    		if ("urlField" in $$props) $$invalidate(3, urlField = $$props.urlField);
    	};
    	...
    	return [roomId, videoTitle, embedUrl, urlField, copyUrl, input_binding];
    }

    class Room extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$8, create_fragment$8, safe_not_equal, { roomId: 0 });
    		...
    		if (/*roomId*/ ctx[0] === undefined && !("roomId" in props)) {
    			console_1.warn("<Room> was created without expected prop 'roomId'");
    		}
    	}
